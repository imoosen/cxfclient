 ...
 * 
 */
@WebServiceClient(name = "FirstServiceService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8080/cxf/ws/fs?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FIRSTSERVICESERVICE_QNAME = new QName("http://service/", "FirstServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/cxf/ws/fs?wsdl");
    ...
    public FirstService getFirstServicePort() {
        return super.getPort(new QName("http://service/", "FirstServicePort"), FirstService.class);
    }
    ...
    public FirstService getFirstServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "FirstServicePort"), FirstService.class, features);
    }
